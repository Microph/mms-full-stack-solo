...
| :------------: | --------------------------------- | ------------------ | ------------------ |
| success | Bool | true |  |
| offers | Objects | [{ studentID: Int, <br>tutorID: Int, <br>subject: String, <br>price: Int, <br>studentConfirm: Bool,<br>student: {<br>&nbsp;&nbsp;name: String,<br>&nbsp;&nbsp;surname: String,<br>&nbsp;&nbsp;gender: String,<br>&nbsp;&nbsp;educationLevel: String,<br>&nbsp;&nbsp;place: List,<br>&nbsp;&nbsp;time: Objects<br>&nbsp;&nbsp;},<br>tutor:{<br>&nbsp;&nbsp;education: Objects,<br>&nbsp;&nbsp;place: Objects,<br>&nbsp;&nbsp;time: Objects,<br>&nbsp;&nbsp;info:{<br>&nbsp;&nbsp;&nbsp;&nbsp;name: String,<br>&nbsp;&nbsp;&nbsp;&nbsp;surname: String,<br>&nbsp;&nbsp;&nbsp;&nbsp;gender: String<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;}<br>}] | found offers |
